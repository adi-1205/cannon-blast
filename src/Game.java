...
// // int speed = 10;
// double cannonScale = 2;
// // double x = 200, y = 435;

// Image cannon = new Image("file:src/cannon.png"); // 0, 0 | 213, 196
// Image wheelOne = new Image("file:src/wheel.png"); // -36, 104
// // Image wheelTwo = new Image("file:src/wheel.png"); // 84, 104
...
// double wheelOneX = x - (36 / cannonScale);
// double wheelOneY = y + (104 / cannonScale);
// double wheelTwoX = x + (84 / cannonScale);
// double wheelTwoY = y + (104 / cannonScale);

// double bodyWidth = 213 / cannonScale;
// double bodyHeight = 196 / cannonScale;
// // double bodyMidX = (x + (cannonWidth / 2));
// double bodyMidX = 200;
// // double bodyMidY = (y + (cannonHeight / 2));
// double bodyMidY = 435;
...
// void update(GraphicsContext gc) {
// // bodyMidX = (x + (cannonWidth / 2));
// // this.updateWheel();
// this.draw(gc);
// System.out.println("body: " + bodyMidX + ", " + bodyMidY);
// }
...
// gc.drawImage(wheelOne, -wheelWidth / 2, -wheelHeight / 2, wheelWidth,
// wheelHeight);
// gc.restore();
...
// // gc.translate(wheelTwoX + wheelWidth / 2, wheelTwoY + wheelHeight / 2);
// // gc.rotate(rotationAngle);
// // gc.drawImage(wheelTwo, -wheelWidth / 2, -wheelHeight / 2, wheelWidth,
// wheelHeight);
// // gc.restore();

// gc.save();
// gc.setFill(Color.RED);
// gc.fillOval(bodyMidX - 2, bodyMidY - 2, 4, 4);
// // gc.setFill(Color.BLUE);
// // gc.fillOval(x - 2, y - 2, 4, 4);
// // gc.setFill(Color.GREEN);
// // gc.fillOval(wheelOneX - 2, wheelOneY - 2, 4, 4);
// gc.restore();
// }
...
// // void moveMouse(double x, double canvasWidth){
// // if((x + wheelTwoX + wheelWidth) < canvasWidth && wheelOneX > 1){
// // this.x = x;
// // }
// // }
